...
const strategies={
  cautious:{products:['weed','shrooms'],areas:['north_star_lot','downtown'],profit:1.10,heatCap:4,plan:'escape',track:'storage',gear:'running_shoes',crew:'eli',encounter:['intimidate','talk','run','pay','surrender']},
  balanced:{products:['weed','shrooms','cocaine'],areas:['north_star_lot','downtown','airport_industrial'],profit:1.15,heatCap:7,plan:'defend',track:'security',gear:'utility_knife',crew:'miri',encounter:['talk','run','fight','pay','surrender']},
  aggressive:{products:['meth','cocaine','shrooms'],areas:['airport_industrial','downtown'],profit:1.18,heatCap:11,plan:'last_score',track:'operations',gear:'cheap_handgun',crew:'tone',encounter:['draw','fight','pay','run','surrender']},
  ...
  stickup:{products:['weed','shrooms'],areas:['north_star_lot'],profit:1.12,heatCap:12,plan:'defend',track:'security',gear:'utility_knife',crew:'tone',encounter:['fight','draw','intimidate','pay','run','surrender'],dealer:'kip'},
};
