...
const strategies={
  ...
  flipper:{products:[],areas:['north_star_lot'],profit:2,heatCap:3,plan:'escape',track:'storage',gear:'running_shoes',crew:'eli',encounter:['talk','run','pay','surrender'],mode:'legal',market:true,marketMargin:12,marketFloat:0,marketQuick:true,marketRiskCap:0.14},
  broker:{products:[],areas:['north_star_lot','downtown'],profit:2,heatCap:4,plan:'escape',track:'storage',gear:'running_shoes',crew:'eli',encounter:['talk','run','pay','surrender'],mode:'legal',market:true,marketMargin:15,marketFloat:0,marketQuick:true,marketRiskCap:0.18},
};
