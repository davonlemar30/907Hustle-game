...
function Header({ state, onMenu }) {
  ...
  return <header className="top">
    <h1 className="sr-only">907Hustle: One Good Run · v1.33</h1>
...
function MenuModal({ state, dispatch, onClose, onTitle }) {
  ...
  return <><Modal title="Run menu" onClose={onClose}>
    <ExpandableMoreSection
      ...
      expandedContent={<p className="popup-flavor">907Hustle v1.33 · Seed {state.run.seed} · Core v{state.version} · storage key {C.SAVE_KEY}</p>}
